        ...
        <div id="smooth-content">
            ...
            <main class="main-bg">
                    ...
                    <div class="container">
                        <div class="sec-head text-center mb-80">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div>
                                        <h6 class="sub-title main-color mb-15">Web and Mobile Development</h6>
                                        <h4>Even the all-powerful Pointing has no control about the blind texts it is an
                                            almost unorthographic life One day however a small line of blind text.</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <ul class="rest list-arrow">
                                            ...
                                            <li class="mt-10 nowrap">
                                                ...
                                                <h6 class="inline fw-400">Best trendinf designing experience.</h6>
                                            </li>
                                            <li class="mt-10 nowrap">
                                                <span class="icon">
                                                    <svg width="100%" height="100%" viewBox="0 0 9 8" fill="none"
                    ...
                    <div class="container">
                        ...
                        <div class="row md-marg">
                            <div class="col-lg-3 col-md-6 item md-mb50">
                                ...
                                <p>Clarifying and translating insights into foundation and creative approach</p>
                                <div class="o-hidden">
                ...
                <section class="testimonials-crev section-padding pb-0 bg-img"
                    data-background="assets/imgs/background/2.jpg" data-overlay-dark="5">
                    <div class="container">
                                    ...
                                    <div class="list-serv">
                                        <div class="accordion bord">
                                            ...
                                            <div class="item active mb-15 wow fadeInUp" data-wow-delay=".1s">
                                                <div class="title">
                                                    <h6>Designing Content With AI
                                                        Power</h6>
                                                    <span class="ico ti-plus"></span>
                                                </div>
                                                <div class="accordion-info">
                                                    <p class="">Taken possession of my entire soul, like
                                                        these sweet
                                                        mornings
                                                        of spring which
